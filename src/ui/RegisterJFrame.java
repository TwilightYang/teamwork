...
public class RegisterJFrame extends JFrame implements MouseListener {
    ...
    private void initView() {
        // 添加注册用户名的文本
        JLabel usernameText = new JLabel(new ImageIcon("images\\register\\username.png"));
        ...
        // 添加注册密码的文本
        JLabel passwordText = new JLabel(new ImageIcon("images\\register\\password.png"));
        ...
        // 添加确认密码的文本
        JLabel rePasswordText = new JLabel(new ImageIcon("images\\register\\rePassword.png"));
        ...
        // 添加注册界面背景图片
        JLabel background = new JLabel(new ImageIcon("images\\register\\background.png"));
